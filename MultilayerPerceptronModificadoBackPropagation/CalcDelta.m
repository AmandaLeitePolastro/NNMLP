...
%obs.: para o perceptron modificado, o cálculo é feito da mesma forma que no perceptron tradicional 
function Delta = CalcDelta(W_layer, Y_layer, Y_true, nlayers)
