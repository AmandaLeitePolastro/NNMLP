...
%GERAÇÃO E PLOT VSE
[x_VSE, VSE] = MultilayerPerceptronBackPropagationVSEv2(x_data_est, y_data_est, x_data_val, y_data_val, B_layer, dimlayers, lr, n);
...
%[Y_MLP_teste] = MultilayerPerceptronBackPropagationTeste(X_data_teste, W_MLP_treino, B_layer, dimlayers);
